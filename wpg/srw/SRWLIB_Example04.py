...
wfr.mesh.zStart = 20.0  # Longitudinal Position [m] at which SR has to be calculated
wfr.mesh.eStart = 1095.0  # 1090. #Initial Photon Energy [eV]
wfr.mesh.eFin = 1095.0  # 1090. #Final Photon Energy [eV]
...
propagParLens = [1, 1, 1.0, 0, 0, 1.0, 1.5, 1.0, 1.5, 0, 0, 0]
...
optBL = SRWLOptC(
    [optLens, optDrift], [propagParLens, propagParDrift]
...
print("done")
print(
    "   Extracting Intensity from calculated Initial Electric Field and saving it to a file ... ",
    end="",
)
...
print("done")
print(
    "   Extracting Intensity from propagated Electric Field and saving it to files ... ",
    end="",
)
