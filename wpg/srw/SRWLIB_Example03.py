...
Bx = 0.57 / 3.0  # Peak Horizontal field [T]
...
wfr1.mesh.zStart = 20.0  # Longitudinal Position [m] at which SR has to be calculated
wfr1.mesh.eStart = 10.0  # Initial Photon Energy [eV]
wfr1.mesh.eFin = 3000.0  # Final Photon Energy [eV]
...
wfr2.mesh.zStart = 20.0  # Longitudinal Position [m] at which SR has to be calculated
wfr2.mesh.eStart = 1090.0  # Initial Photon Energy [eV]
wfr2.mesh.eFin = 1090.0  # Final Photon Energy [eV]
...
print(
    "   Performing Electric Field (spectrum vs photon energy) calculation ... ", end=""
)
...
print("done")
print(
    "   Performing Electric Field (wavefront at fixed photon energy) calculation ... ",
    end="",
)
...
uti_plot1d(
    arI1,
    [wfr1.mesh.eStart, wfr1.mesh.eFin, wfr1.mesh.ne],
    ["Photon Energy [eV]", "Intensity [ph/s/.1%bw/mm^2]", "On-Axis Spectrum"],
)
uti_plot2d(
    arI2,
    [1000 * wfr2.mesh.xStart, 1000 * wfr2.mesh.xFin, wfr2.mesh.nx],
