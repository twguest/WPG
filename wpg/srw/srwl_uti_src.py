...
def srwl_uti_src_e_beam_predef():  # OC25012017
    ...
    allBeams = [
        ...
        [
            "NSLS-II Low Beta Day 1",
            [0.5, 3, 0.89e-03, 0.9e-09, 1.84, 0, 0, 0, 8e-12, 1.17, 0],
        ],
        [
            "NSLS-II Low Beta Final",
            [0.5, 3, 0.89e-03, 0.55e-09, 1.84, 0, 0, 0, 8e-12, 1.17, 0],
        ],
        ...
        [
            "NSLS-II High Beta Day 1",
            [0.5, 3, 0.89e-03, 0.9e-09, 20.1, 0, 0, 0, 8e-12, 3.4, 0],
        ],
        [
            "NSLS-II High Beta Final",
            [0.5, 3, 0.89e-03, 0.55e-09, 20.1, 0, 0, 0, 8e-12, 3.4, 0],
        ],
        [
            "NSLS-II 3PW Day 1",
            [
        ...
        [
            "NSLS-II BM Day 1",
            [0.5, 3, 0.89e-03, 0.9e-09, 1.5, 0, 0.137, -0.1, 8e-12, 22.5, -0.9],
        ],
        [
            "NSLS-II BM Final",
            [0.5, 3, 0.89e-03, 0.55e-09, 1.5, 0, 0.137, -0.1, 8e-12, 22.5, -0.9],
        ],
        [
            "DIAMOND Low Beta",
            [0.3, 3, 1.0e-03, 2.797e-09, 2.283, 0, 0, 0, 24.32e-12, 2.514, 0],
        ],
        [
            "SOLEIL Short",
            [0.5, 2.75, 1.016e-03, 3.73e-09, 17.78, 0, 0.28, 0, 37e-12, 1.75, 0],
        ],
        [
            "SOLEIL Medium",
            [0.5, 2.75, 1.016e-03, 3.73e-09, 4.0, 0, 0.13, 0, 37e-12, 1.77, 0],
        ],
        [
            "SOLEIL Long",
            [0.5, 2.75, 1.016e-03, 3.73e-09, 10.09, 0, 0.2, 0, 37e-12, 8.01, 0],
        ],
        [
            "SOLEIL BM 1 deg.",
            [
        ...
        [
            "ESRF Low Beta",
            [0.2, 6.04, 1.1e-03, 4.0e-09, 0.35, 0, 0.031, 0, 25e-12, 2.97, 0],
        ],
        [
            "ESRF High Beta",
            [0.2, 6.04, 1.1e-03, 4.0e-09, 37.6, 0, 0.134, 0, 25e-12, 2.95, 0],
        ],
        [
            "ESRF BM",
            [0.2, 6.04, 1.1e-03, 4.0e-09, 2.2, 1.43, 0.045, 0, 25e-12, 34.9, 0],
        ],  # to correct _alpha_x, _alpha_y, _eta_x_pr
        [
            "ESRF-U BM",
            [
                0.2,
        ...
        [
            "SPring8 High Beta",
            [0.1, 8, 1.1e-03, 3.4e-09, 22.6, 0, 0.107, 0, 6.8e-12, 5.6, 0],
        ],
    ]  # add more beams
    return allBeams
...
def srwl_uti_src_sph_wave(_wfr, _pol, _norm=1):  # Move it to different place (C part?)
    ...
    eStep = (
        0
        if (_wfr.mesh.ne <= 1)
        else (_wfr.mesh.eFin - _wfr.mesh.eStart) / (_wfr.mesh.ne - 1)
    )
