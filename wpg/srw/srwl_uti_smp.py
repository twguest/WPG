...
class SRWLUtiSmp:
    ...
    def __init__(
        ...
        output_image_format = (
            os.path.splitext(file_path)[1].replace(".", "")
    ...
    def get_data_from_image(self):
        ...
        if self.area:
            ...
            self.data = self.data[
                self.area[2] : self.area[3], self.area[0] : self.area[1]
            ]
            ...
            for ix in range(nx):
                ...
                if specPropAreDef:
                    for ie in range(ne):
                        ...
                        arTr[offset] = math.exp(
                            miHalfPathInBody / atten_len[ie]
