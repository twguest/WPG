...
def srwl_uti_cryst_pl_sp(_hr=None, _mat="Si"):
    ...
    d = None
    if _mat == "Si":
        d = 5.43096890  # Si lattice constant (A)
    # to extend this for other crystal materials here
    else:
        raise Exception(strMatDataNotDefined)
    ...
    if _hr is None:
        ...
        return d / sqrt(sum(n * n for n in _hr))
...
def srwl_uti_cryst_pol_f(_en, _hr, _mat="Si"):
    ...
    def interp_f1f2(x, y1, y2, z):
        ...
        if nn > 0 & nn < len(x):
            ...
            raise Exception("Argument is out of range of existing tabulated data")
        return [f1, f2]
    ...
    if _mat == "Si":
        ...
        rCell = [
            ...
            [0.75, 0.25, 0.75],
            [0.25, 0.75, 0.75],
        ]  # coordinates of atoms in Si cell
    ...
    xh = 0.5 / dr
    # f0 = SiASF(0.)
    f0 = srwl_uti_cryst_ASF(0.0, _mat)

    cF = wA * wA * re / (pi * Vc)
    psi0r = -8.0 * cF * (f0 + fE[0])
    psi0i = 8.0 * cF * fE[1]
    # f0 = SiASF(xh)
