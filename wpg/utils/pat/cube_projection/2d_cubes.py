...
def make_rot_cube(cube2_length=20):
    ...
    cube2[
        cube2_corner_length : 2 * cube2_corner_length, 0:cube2_corner_length
    ] = np.rot90(cube2_corner)
    cube2[
        cube2_corner_length : 2 * cube2_corner_length,
        cube2_corner_length : 2 * cube2_corner_length,
    ] = np.rot90(cube2_corner, 2)
    cube2[
        0:cube2_corner_length, cube2_corner_length : 2 * cube2_corner_length
    ] = np.rot90(cube2_corner, 3)
...
def add_cube_to_sample(cube, sample):
    ...
    count = 0
    while (
        pos[0] + cube.shape[0] > sample.shape[0]
        or pos[1] + cube.shape[1] > sample.shape[1]
    ):
    ...
    new_sample[pos[0] : pos[0] + cube.shape[0], pos[1] : pos[1] + cube.shape[1]] = (
        sample[pos[0] : pos[0] + cube.shape[0], pos[1] : pos[1] + cube.shape[1]] + cube
    )
