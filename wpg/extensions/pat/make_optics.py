...
def my_hfm():
    HFM = srwlib.SRWLOptMirSph(_r=8871.45, _size_tang=0.95, _size_sag=0.005, _nvx=0.999902524484, _nvy=0.0,
...
def my_dcm(orient):
    ...
    opCr = srwlib.SRWLOptCryst(_d_sp=3.13557135638, _psi0r=-1.80680829752e-05, _psi0i=4.94786384696e-07,
                               _psi_hr=-9.56518891953e-06, _psi_hi=3.45446815392e-07, _psi_hbr=-9.56518891953e-06,
                               _psi_hbi=3.45446815392e-07, _tc=0.01, _ang_as=0.0)

    if orient == 1:
        # opCr.set_orient(-0.970946542231, 6.59748146207e-09, -0.239296494187, -0.239296494187, 1.62599496025e-09)
        opCr.set_orient(-0.258293438037, 0.928106834743, -0.268145861745, -0.0718931646453, 0.258328426713)
    else:
...
def my_kbmV(source_focus, image_focus):
    ...
    mirror = srwlib.SRWLOptMirEl(_p=source_focus, _q=image_focus, _ang_graz=0.003, _size_tang=0.22, _size_sag=1e6,
                                 _nvx=0.999995500003, _nvy=0.0, _nvz=-0.0029999955,
                                 _tvx=0.0029999955,_tvy=0.0, _x=0.0, _y=0.0)
...
def my_kbmH(source_focus, image_focus):
    ...
    mirror = srwlib.SRWLOptMirEl(_p=source_focus, _q=image_focus, _ang_graz=0.003, _size_tang=0.22, _size_sag=1e6,
                                 _nvx=0.0, _nvy=0.999995500003, _nvz=-0.0029999955,
                                 _tvx=0.0,_tvy=0.0029999955, _x=0.0, _y=0.0)
    return mirror
