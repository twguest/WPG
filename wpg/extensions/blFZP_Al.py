...
# =============================================================================
    ...
    elCS = bl(SRWLOptC(_arOpt=[SRWLOptA("c", "o", p.CS.xwidth, p.CS.ywidth, 0.0, 0.0)],
               _arProp=[p.CS.pp]),
    ...
    elOSA = bl(SRWLOptC(_arOpt=[SRWLOptA("c", "a", p.OSA.xwidth, p.OSA.ywidth, 0.0, 0.0)],
               _arProp=[p.OSA.pp]),
    ...
    for section in OpticalSystem:
          ...
          if p.SAVE_SNAPSHOTS is True: #Save intensity image
              writeIntensity(wfr,
                             ...
                             imgType='tif')
#             
              plot_map_I(wfr, save=strOutPath+ section.description+'_profile.tif', range_x=2.0e-3, range_y=2.0e-3,im_aspect='equal') #range_x in mm
...
if __name__ == '__main__':
    ...
    try:
        ...
        main('extensions.parameters.BLParamsFZP')
