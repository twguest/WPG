...
# =============================================================================
  ...
  #  blfocusVol.description=p.focusVol.description 
    ...
    if (os.path.exists(p.CACHEPATH+p.wfFocusXPath)):
        ...
        OpticalSystem = [#blRescAfterOSA,#elCS,
                     blDriftToFocus, 
                     blSaveFocus,
                     elOSA,
                     blSavePostOSA,
...
#                         blSaveDetector]
        ...
        wfr = constructTestWaveField(npoints=500, ekeV=p.EkeV, show = p.SHOWPLOTS)
...
if __name__ == '__main__':
    ...
    try:
        ...
        main('extensions.parameters.BLParams_forKino_For50s')
