...
sys.path.append(
    r"C:\Users\twguest\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations"
)
sys.path.append(
    r"C:\Users\twguest\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations/root"
)
sys.path.append(
    r"C:\Users\twguest\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations/utils"
)

sys.path.append(
    r"C:\Users\daemo\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations"
)
sys.path.append(
    r"C:\Users\daemo\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations/root"
)
sys.path.append(
    r"C:\Users\daemo\OneDrive - LA TROBE UNIVERSITY\code\WPG_Wavefront_Simulations/utils"
)
...
class np_to_sample:
    ...
    def __init__(
        ...
        if self.tile:
            assert type(self.tile) in [
                list,
                tuple,
            ], "The type of tile ({}) should be list/tuple".format(
    ...
    def _check_files(self):
        if not os.path.isfile(self.file_path):
            raise ValueError(
                'Provided file "{}" does not exist.'.format(self.file_path)
            )
